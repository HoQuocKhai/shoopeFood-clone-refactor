...
export default function HomePage() {
  ...
  const menuFoods = useMemo(() => {
    ...
    return foods.filter(
      (food) => food.categoryId !== null && activeCategoryIds.has(food.categoryId)
    );
  ...
  function validateCheckout() {
    ...
    if (
      !Number.isFinite(Number(checkout.receiverLat)) ||
      !Number.isFinite(Number(checkout.receiverLng))
    ) {
      ...
      <div className="order-layout">
        ...
        <main className="menu-panel">
          ...
          <div className="menu-grid">
            ...
            {!isLoading && visibleFoods.length === 0 ? (
              <p className="empty-state">Chua co mon phu hop.</p>
            ) : null}
          </div>
        </main>
        ...
        <aside className="checkout-panel" id="checkout" aria-label="Gio hang">
          ...
          <div className="cart-list">
            ...
            {cartItems.length === 0 ? (
              <p className="cart-empty">Chon mon de bat dau dat hang.</p>
            ) : null}
          </div>
          ...
          <form className="checkout-form" onSubmit={handleSubmitOrder}>
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  setCheckout((current) => ({ ...current, customerId: event.target.value }))
                }
              />
            </label>
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  setCheckout((current) => ({ ...current, receiverAddress: event.target.value }))
                }
              />
            </label>
            ...
            <div className="checkout-grid">
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setCheckout((current) => ({ ...current, receiverLat: event.target.value }))
                  }
                />
              </label>
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setCheckout((current) => ({ ...current, receiverLng: event.target.value }))
                  }
                />
              </label>
            </div>
            ...
            <div className="checkout-grid">
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setCheckout((current) => ({ ...current, distanceKm: event.target.value }))
                  }
                />
              </label>
              <label>
          ...
          {successOrder ? (
            <div className="order-success">
              ...
              <div>
                ...
                <span>
                  {formatPrice(successOrder.totalAmount)} VND ·{' '}
                  {successOrder.statusLabel || successOrder.statusCode}
                </span>
              </div>
