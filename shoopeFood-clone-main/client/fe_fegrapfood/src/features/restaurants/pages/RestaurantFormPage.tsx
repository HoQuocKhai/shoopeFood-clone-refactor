...
import { createRestaurant, getRestaurantById, updateRestaurant } from '../api/restaurants';
...
export default function RestaurantFormPage() {
  ...
  function handleFieldChange<K extends keyof RestaurantFormState>(
    field: K,
          ...
          <form className="restaurant-form" onSubmit={handleSubmit}>
            ...
            <div className="restaurant-form-actions">
              ...
              <button type="submit" className="button-primary" disabled={isSubmitting}>
                {isSubmitting ? 'Đang lưu...' : isEditMode ? 'Cập nhật nhà hàng' : 'Tạo nhà hàng'}
              </button>
            </div>
          </form>
        ) : null}
