const { DEFAULT_ORDER_STATUS_CODE } = require('../../../factories/orderFactory'); // Assuming we will keep or move this
...
module.exports = {
  normalizeOrder,
  normalizeOrderItem,
  normalizeRestaurantForTracking,
  normalizeDriverForTracking,
