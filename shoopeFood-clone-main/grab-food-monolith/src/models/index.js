...
RestaurantChangeRequest.belongsTo(User, {
  foreignKey: 'approvedBy',
  targetKey: 'id',
  as: 'reviewerUser',
});

Restaurant.hasMany(RestaurantChangeRequest, {
  foreignKey: 'restaurantId',
  sourceKey: 'id',
  as: 'changeRequests',
});
RestaurantChangeRequest.belongsTo(Restaurant, {
  foreignKey: 'restaurantId',
  targetKey: 'id',
  as: 'restaurant',
});
...
// OrderStatusLog: no FK constraints because orders is a partitioned table
// (MySQL does not support FK on partitioned tables – referential integrity enforced at app layer)
...
OrderStatusLog.belongsTo(Order, { foreignKey: 'orderId', targetKey: 'id', constraints: false });
